...
Feature: Testing out the basic step definitions for JSON
  ...
  Scenario: Custom Consumer
    ...
    And the response value of "users[0].username" should equal "Bret"
    And the response value of "users[0].address.zipcode" should equal "92998-3874"
    And the response value of "users[0].address.geo.lat" should equal float "-37.3159"